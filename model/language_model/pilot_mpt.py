...
from pilot.model.pilot_arch import pilotMetaModel, pilotMetaForCausalLM


class pilotMPTConfig(MPTConfig):
    model_type = "pilot_mpt"


class pilotMPTModel(pilotMetaModel, MPTModel):
    config_class = pilotMPTConfig

    def __init__(self, config: MPTConfig):
        config.hidden_size = config.d_model
        super(pilotMPTModel, self).__init__(config)
    
    def embed_tokens(self, x):
        return self.wte(x)


class pilotMPTForCausalLM(MPTForCausalLM, pilotMetaForCausalLM):
    config_class = pilotMPTConfig
    ...
    def __init__(self, config):
        ...
        self.transformer = pilotMPTModel(config)
    ...
    def _set_gradient_checkpointing(self, module, value=False):
        if isinstance(module, pilotMPTModel):
...
AutoConfig.register("pilot_mpt", pilotMPTConfig)
AutoModelForCausalLM.register(pilotMPTConfig, pilotMPTForCausalLM)
